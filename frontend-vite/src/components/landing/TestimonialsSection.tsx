...
export default function TestimonialsSection() {
  return (
    <section className="relative overflow-hidden bg-[#030805] px-4 pb-10 pt-6 text-white sm:px-6 lg:px-8 xl:px-10">
      ...
      <div className="relative mx-auto w-full max-w-[1280px]">
        <div className="grid items-start gap-8 lg:grid-cols-[320px_minmax(0,1fr)] xl:grid-cols-[330px_minmax(0,1fr)] xl:gap-10">
          <motion.div
            ...
            className="pt-0"
          >
            <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-lime-400/25 bg-lime-400/8 px-4 py-2 text-xs font-black uppercase tracking-wide text-lime-300 shadow-[0_0_32px_rgba(163,230,53,0.08)]">
              <Users className="h-4 w-4" />
              Testimonials
            </div>

            <h2 className="max-w-[340px] text-[36px] font-black leading-[1.04] tracking-[-0.06em] text-[#F7FFF2] sm:text-[44px] lg:text-[46px] xl:text-[50px]">
              Real People. Real{" "}
              <span className="text-lime-300">Results.</span> Backed by
              Science.
            </h2>

            <p className="mt-5 max-w-[340px] text-[15px] leading-7 text-white/68">
              Thousands of Indians are transforming their health with
              AI-powered nutrition that understands their lifestyle, food and
              goals.
            </p>

            <div className="mt-7 max-w-[285px] rounded-[1.35rem] border border-lime-400/25 bg-white/[0.035] p-5 shadow-[0_0_45px_rgba(163,230,53,0.06)] backdrop-blur-xl">
            ...
            <div className="mt-7 grid max-w-[360px] grid-cols-4">
              {stats.map((stat) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="text-[21px] font-black tracking-[-0.04em] text-lime-300">
                      {stat.value}
                    </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
              {testimonials.map((item, index) => (
                <motion.article
                  ...
                  className="group relative overflow-hidden rounded-[1.35rem] border border-lime-400/20 bg-[#07130c]/80 p-4 shadow-[0_18px_70px_rgba(0,0,0,0.32)] backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:border-lime-400/40 hover:shadow-[0_0_55px_rgba(163,230,53,0.12)]"
                >
                  ...
                  <div className="relative z-10 flex items-start gap-4">
                    <div className="relative h-[60px] w-[60px] shrink-0 overflow-hidden rounded-full border border-white/15 bg-lime-400/10">
                      <img
                        src={item.avatar}
                        alt={item.name}
                  ...
                  <p className="relative z-10 mt-5 min-h-[86px] text-[14.5px] leading-7 text-white/76">
                    {item.text}
                  </p>

                  <div className="relative z-10 mt-4 grid grid-cols-2 overflow-hidden rounded-2xl border border-lime-400/18 bg-black/24">
                    {item.chips.map((chip) => {
                      ...
                      return (
                        ...
                        >
                          <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-lime-400/14 text-lime-300">
