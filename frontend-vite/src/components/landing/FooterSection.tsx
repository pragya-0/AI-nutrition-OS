...
export default function FooterSection() {
  return (
    <footer className="relative overflow-visible bg-[#030805] pb-16 pt-12 text-white">
      ...
      <div className="relative mx-auto w-full max-w-[1380px] px-6 sm:px-8 lg:px-10">
        {/* CTA PANEL */}
        <div className="relative mx-auto max-w-[1280px] overflow-hidden rounded-[28px] border border-[#9DFF0024] bg-[#07110C]/72 px-7 py-6 shadow-[0_0_70px_rgba(166,255,0,0.07)] backdrop-blur-xl lg:px-12 lg:py-7">
        ...
        {/* FOOTER GRID */}
        <div className="mx-auto grid w-full max-w-[1280px] gap-10 border-b border-[#A6FF001A] pb-10 pt-12 lg:grid-cols-[0.82fr_0.82fr_0.92fr_0.88fr_0.88fr_0.88fr_1.55fr]">
          <div className="pb-2">
          ...
          <div className="max-w-[340px] border-l border-[#A6FF001A] pb-2 pl-10">
            ...
            <h4 className="mt-5 text-[24px] font-black text-[#A6FF00]">
              Stay Updated
            </h4>
        ...
        <div className="mx-auto flex w-full max-w-[1280px] flex-col gap-6 pb-0 pt-6 text-[14px] text-white/58 lg:flex-row lg:items-center lg:justify-between">
